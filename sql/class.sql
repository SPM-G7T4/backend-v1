...
INSERT INTO `class` (`class_id`, `class_size`, `trainer_email`, `course_id`) 
VALUES (1, 40, "jiale@smu.edu.sg", "REP1101");

INSERT INTO `class` (`class_id`, `class_size`, `trainer_email`, `course_id`) 
VALUES (2, 40, "swarna@smu.edu.sg", "REP1101");

INSERT INTO `class` (`class_id`, `class_size`, `course_id`) 
VALUES (1, 40, "REP2101");
