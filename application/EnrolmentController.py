...
class EnrolmentController():
    def create_enrolment(self, request_body):
        try :
    ...
    def view_enrolment(self, input_learner_email=None):
        try:
            listOfEnrolments = []
    ...
    def change_enrolment_status(self, request_body):
        try :
